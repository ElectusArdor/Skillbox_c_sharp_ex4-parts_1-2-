...
namespace GameOfLife
{
    ...
    public class LifeSimulation
    {
        ...
        public LifeSimulation(int Heigth, int Width, int MaxAge)
        {
            _maxAge = MaxAge;
            _heigth = Heigth;
            _width = Width;
            cells = new bool[Heigth, Width];
            age = new int[Heigth, Width];
            GenerateField();
        }
    ...
    internal class Program
    {
        ...
        {
            int runs = 0;
            LifeSimulation sim = new LifeSimulation(Heigth, Width, MaxAge);
